...
$modal-editor-theme-color: var(
  --jse-modal-editor-theme-color,
  var(--jse-modal-theme-color, #707070)
);
$modal-editor-theme-color-highlight: var(
  --jse-modal-editor-theme-color-highlight,
  var(--jse-modal-theme-color-highlight, #646464)
);
...
$search-match-outline: var(--jse-search-match-outline, (1px solid #ffd700));
$search-match-active-color: var(--jse-search-match-active-color, #ffd700);
$search-match-active-outline: var(--jse-search-match-active-outline, (1px solid #e1be00));
